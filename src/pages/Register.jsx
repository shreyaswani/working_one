...
function Register({toggleForm}) {
  ...
  return (
<div id="loginPopup" className="overlay">
    <form className="form" onSubmit={handleRegister}>
      ...
      <div className="flex-row">
        <button type="button" onClick={googleLogin} className="btnforlogio google">
          <svg version="1.1" width="20" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" style={{ enableBackground: 'new 0 0 512 512' }}>
        ...
        <button type="button" className="btnforlogio apple">
          <svg version="1.1" height="20" width="20" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 22.773 22.773" style={{ enableBackground: 'new 0 0 22.773 22.773' }}>
            <g>
              <g>
